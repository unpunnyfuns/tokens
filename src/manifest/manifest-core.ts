...
import { resolveASTReferences } from "../ast/index.js";
...
import { isValidManifest, validateManifest } from "../validation/index.js";
import { collectFiles, loadAndMergeFiles } from "./manifest-files.js";
import { filterFiles } from "./manifest-filtering.js";
import {
  expandGenerateSpec,
  expandSpecWithFiltering,
  generateAllPermutations,
} from "./manifest-generation.js";
import { validateInput } from "./manifest-validation.js";
import type {
  GenerateSpec,
  ResolutionInput,
  ResolvedPermutation,
...
export async function resolvePermutation(
  ...
  if (manifest.options?.resolveReferences) {
    ...
    resolvedTokens = astToTokens(ast);
  }
